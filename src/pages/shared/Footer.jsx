      ...
      <div className="container px-6 pt-12 pb-8 mx-auto">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4 lg:pl-12 ">
          <div className="sm:col-span-2">
            ...
            <div className="flex flex-col mx-auto mt-6 space-y-3 md:space-y-0 md:flex-row">
              ...
              <button className="w-full px-6 py-2.5 text-sm font-medium tracking-wider text-white transition-colors duration-300 transform md:w-auto md:mx-4 focus:outline-none bg-[#D4A373] rounded-lg hover:bg-[#AD8B73]">
                Subscribe
              </button>
            </div>
          </div>
          ...
          <div>
            <p className="font-bold text-gray-800 font-lora text-xl">
              Quick Link
            </p>
            ...
            <div className="flex flex-col items-start mt-5 space-y-2">
              <a
                href="#"
                className="text-gray-600 transition-colors duration-300 hover:underline hover:text-[#AD8B73]"
              >
                Home
              </a>
              <a
        ...
        <div className="flex items-center justify-between ">
          ...
          <div className="-mx-2 flex">
            <a
              href="#"
              className="mx-2 text-gray-600 transition-colors duration-300 hover:text-[#AD8B73]"
              aria-label="Reddit"
            >
              <svg

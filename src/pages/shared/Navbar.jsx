        ...
        <div className="lg:flex lg:items-center lg:justify-between">
          ...
          <div
            className={` absolute inset-x-0 z-20 w-full px-6 py-4 transition-all duration-300 ease-in-out bg-white lg:mt-0 lg:p-0 lg:top-0 lg:relative lg:bg-transparent lg:w-auto lg:opacity-100 lg:translate-x-0 lg:flex lg:items-center ${
              isOpen
                ? "translate-x-0 opacity-100 bg-gradient-to-b from-[#FEFAE0] "
                : "opacity-0 -translate-x-full"
            }`}
          >
            <div className=" flex flex-col -mx-6 lg:flex-row lg:items-center lg:mx-8 space-y-5 lg:space-y-0">
              <div className="">
              ...
              {/* my profile */}
              <div className="relative inline-block transition-colors duration-300 transform lg:mt-0  hover:text-gray-600 ">
                {/* Dropdown toggle button */}
                <button
                  onClick={() => setDropdown(!dropdown)}
                  className=" hover:bg-[#CEAB93]  mx-3  relative z-10 flex items-center py-1 px-2 text-gray-700  rounded-md"
                >
              ...
              <label className="swap swap-rotate flex justify-start lg:grid w-min">
                ...
                {/* sun icon */}
                <svg
                  className="swap-off fill-current size-8 mx-4"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                >
                ...
                {/* moon icon */}
                <svg
                  className="swap-on fill-current size-8 mx-2"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                >
                  ...
                  <div className="flex items-center mt-4 lg:mt-0">
                    ...
                    >
                      <div
                        ...
                        className="mx-3 size-10 overflow-hidden border-2 border-gray-400 rounded-full"
                      >
                        <img
